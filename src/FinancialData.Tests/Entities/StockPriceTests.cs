...
public class StockPriceTests
{
    ...
    ""volume"": 40000000.0
        ...
        // Which one "wins" is not defined, as this case can never occur.
        Assert.IsTrue(stockPrice.Date != default);
        Assert.IsTrue(stockPrice.Time != default);
    }
    ...
    [TestMethod]
    public void StockPrice_ToString_ReturnsJson()
    {
        var json = @"{
    ""trading_symbol"": ""TEST"",
    ""open"": 100.00,
    ...
    ""volume"": 1000000.0
        ...
        // Act
        var actual = stockPrice.ToString();

        // Assert
        Assert.Contains("105", actual);
    }
}
# fdncs
C# SDK for [FinancialData.Net](https://financialdata.net/) API

[![Build and Deploy](https://github.com/tudormobile/fdncs/actions/workflows/dotnet.yml/badge.svg)](https://github.com/tudormobile/fdncs/actions/workflows/dotnet.yml)  [![Publish Docs](https://github.com/tudormobile/fdncs/actions/workflows/docs.yml/badge.svg)](https://github.com/tudormobile/fdncs/actions/workflows/docs.yml)
...
[MIT Licence](LICENSE). Copyright (c) 2026 Bill Tudor

[NuGET Package README](src/FinancialData/README.md) | [Source Code README](src/README.md) | [API Documentation](https://tudormobile.github.io/fdncs/)
